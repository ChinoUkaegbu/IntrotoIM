...
+ I also found out the dimensions I had to use for the ball too look as if it were rolling smoothly on the ground. Now I have to see how I'll implement this when I change it from a ball to the actual object that would catch the falling objects. Sigh
